...
public class EnergyConsumptionSensor extends Sensor {

    private JSONObject sensorInfo;

    public EnergyConsumptionSensor(int port, String name, int sendInterval) {
    ...
    public void sendValue(Date simTime) {
        ...
        float energy = Simulation.getInstance().getEnergySimulator().getConsumption();
